        ...
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Update employee profile: <?php echo htmlspecialchars($employee['first_name'] . ' ' . $employee['last_name']); ?>
                </p>
            </div>
        </div>
    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="emp_code" id="emp_code" 
                               value="<?php echo htmlspecialchars($employee['emp_code']); ?>"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="address" id="address" rows="3" class="form-textarea"><?php echo htmlspecialchars($employee['address']); ?></textarea>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="leave_date" id="leave_date" 
                               value="<?php echo $employee['leave_date']; ?>"
                               class="form-input">
                    </div>
                        ...
                        <select name="designation_id" id="designation_id" required class="form-select">
                            ...
                            <?php foreach ($designations as $designation): ?>
                                <option value="<?php echo $designation['id']; ?>"
                                        <?php echo $employee['designation_id'] == $designation['id'] ? 'selected' : ''; ?>>
                        ...
                        <select name="cost_center_id" id="cost_center_id" class="form-select">
                            ...
                            <?php foreach ($cost_centers as $center): ?>
                                <option value="<?php echo $center['id']; ?>"
                                        <?php echo $employee['cost_center_id'] == $center['id'] ? 'selected' : ''; ?>>
                        ...
                        <select name="reporting_manager_id" id="reporting_manager_id" class="form-select">
                            ...
                            <?php foreach ($managers as $manager): ?>
                                <option value="<?php echo $manager['id']; ?>"
                                        <?php echo $employee['reporting_manager_id'] == $manager['id'] ? 'selected' : ''; ?>>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="pan_number" id="pan_number" 
                               ...
                               class="form-input" placeholder="ABCDE1234F" maxlength="10">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="aadhaar_number" id="aadhaar_number" 
                               value="<?php echo htmlspecialchars($employee['aadhaar_number']); ?>"
                               class="form-input" placeholder="1234 5678 9012" maxlength="12">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="uan_number" id="uan_number" 
                               value="<?php echo htmlspecialchars($employee['uan_number']); ?>"
                               class="form-input" placeholder="123456789012" maxlength="12">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="esi_number" id="esi_number" 
                               value="<?php echo htmlspecialchars($employee['esi_number']); ?>"
                               class="form-input">
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_ifsc" id="bank_ifsc" 
                               ...
                               class="form-input" placeholder="SBIN0001234" maxlength="11">
                    </div>
                </div>
            </div>
        </div>
