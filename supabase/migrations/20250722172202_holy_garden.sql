...
(5, 'Provident Fund', 'PF', 'deduction', 'BASIC * 0.12', 1, 0, 0, 5),
(6, 'ESI Contribution', 'ESI', 'deduction', '(BASIC + HRA + TA + MA) * 0.0075', 0, 0, 0, 6),
(7, 'Professional Tax', 'PT', 'deduction', '200', 0, 0, 0, 7),
(8, 'Income Tax (TDS)', 'TDS', 'deduction', NULL, 0, 0, 0, 8);
...
(1, 5, 3600.00, '2023-01-01'),  -- PF
(1, 6, 337.50, '2023-01-01'),   -- ESI
(1, 7, 200.00, '2023-01-01'),   -- PT
...
(2, 5, 5400.00, '2023-02-01'),  -- PF
(2, 7, 200.00, '2023-02-01'),   -- PT
...
(3, 5, 7200.00, '2023-03-01'),  -- PF
(3, 7, 200.00, '2023-03-01');   -- PT
...
INSERT INTO `payroll_periods` (`period_name`, `start_date`, `end_date`, `financial_year`) VALUES
('January 2024', '2024-01-01', '2024-01-31', '2023-2024'),
('February 2024', '2024-02-01', '2024-02-29', '2023-2024'),
('March 2024', '2024-03-01', '2024-03-31', '2023-2024'),
('April 2024', '2024-04-01', '2024-04-30', '2024-2025'),
('May 2024', '2024-05-01', '2024-05-31', '2024-2025');
